	<?php 
		...
		$datetime = isset($lastRawdata->datetime)?($lastRawdata->datetime):date('Y-m-d H:i:s');
        ...
        <section class="content">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                <div class="inner">
                  <p>{{date('d-m-Y H:i:s',strtotime($datetime))}}</p>
                  <p>Date & Time</p>
                </div>
                <div class="icon">
					...
					/* Highcharts.stockChart('chartCnt', {
						chart: {
							events: {
								load: function () {
									this.setTitle(null, {
										text: 'Water Level ' + (new Date() - start) + 'ms'
									});
								}
							},
							zoomType: 'x'
						...
						subtitle: {
							text: 'Water Level' // dummy text to reserve space for dynamic subtitle
						},
